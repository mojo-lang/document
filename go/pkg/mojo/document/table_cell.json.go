...
func init() {
	core.RegisterJSONTypeDecoder("document.Table_Cell", &TableCellCodec{})
	core.RegisterJSONTypeEncoder("document.Table_Cell", &TableCellCodec{})
}
